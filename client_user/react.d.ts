...
declare namespace React {
    ...
    interface DOMAttributes<T> {
		...
		onkeypress?: (e: NativeKeyboardEvent) => void;
		...
		ontouchend?: (e: NativeTouchEvent) => void;
...
declare global {
    namespace JSX {
        ...
        //type LibraryManagedAttributes2<C, P> = C extends { propTypes: infer T; defaultProps: infer D; }
